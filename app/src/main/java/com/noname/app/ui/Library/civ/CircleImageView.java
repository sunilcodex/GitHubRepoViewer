package com.noname.app.ui.Library.civ;
...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleImageView_class, 0, 0);
            strokeColor = a.getColor(R.styleable.CircleImageView_class_strokeColor, Color.TRANSPARENT);
            strokeWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_class_strokeWidth, 0);
            highlightEnable = a.getBoolean(R.styleable.CircleImageView_class_highlightEnable, true);
            highlightColor = a.getColor(R.styleable.CircleImageView_class_highlightColor, DEF_PRESS_HIGHLIGHT_COLOR);
            a.recycle();
        }
